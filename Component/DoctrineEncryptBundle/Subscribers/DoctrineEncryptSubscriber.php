...
namespace EWS\Component\DoctrineEncryptBundle\Subscribers;
...
use \ReflectionClass;
use EWS\Component\DoctrineEncryptBundle\Encryptors\EncryptorInterface;
...
class DoctrineEncryptSubscriber implements EventSubscriber {
    ...
    const ENCRYPTOR_INTERFACE_NS = 'EWS\Component\DoctrineEncryptBundle\Encryptors\EncryptorInterface';

    /**
     * Encrypted annotation full name
     */
    const ENCRYPTED_ANN_NAME = 'EWS\Component\DoctrineEncryptBundle\Configuration\Encrypted';
